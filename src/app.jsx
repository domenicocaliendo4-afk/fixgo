...
function LoginPage() {
  ...
  return h('div', { className: 'auth-page' },
    ...
    h('div', { className: 'error-msg' }, error),
    h('button', { className: 'btn-google', onClick: handleGoogle },
  ...
  return h('div', { className: 'auth-page' },
    ...
    h('form', { onSubmit: handleSubmit },
      h('div', { className: 'form-group' },
        ...
        h('input', {
          className: 'form-input', type: 'text', placeholder: 'Mario Rossi',
          value: name, onChange: e => setName(e.target.value), required: true, autoComplete: 'name'
        })
      ),
      h('div', { className: 'form-group' },
        h('label', { className: 'form-label' }, 'Email'),
